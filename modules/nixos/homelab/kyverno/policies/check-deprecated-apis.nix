{ ... }:
{
  services.k3s.manifests."kyverno-policies-check-deprecated-apis".content = [
    {
          ...
          }
          {
            ...
            match = {
              any = [
                {
                  resources = {
                    kinds = [ "storage.k8s.io/*/CSIStorageCapacity" ];
                  };
                }
              ];
            };
            ...
            preconditions = {
              all = [
                ...
                }
                {
                  key = "{{request.object.apiVersion}}";
                  operator = "AnyIn";
                  value = [ "flowcontrol.apiserver.k8s.io/v1beta2" ];
                }
              ];
            };
            validate = {
